...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        {"--triattention-prune-prefill"},
        "allow eviction during prefill, not just decode (default: defer all eviction until decode)",
        [](common_params & params) {
            params.triattention_prune_prefill = true;
        }
    ).set_examples({LLAMA_EXAMPLE_SERVER, LLAMA_EXAMPLE_CLI}));
    add_opt(common_arg(
        {"--triattention-no-prune-prefill"},
        "defer all eviction until decode, never prune during prefill (default behavior, flag kept for compatibility)",
        [](common_params & params) {
