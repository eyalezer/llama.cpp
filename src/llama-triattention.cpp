...
extern "C" {
    void dequantize_row_q1_0(const void * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
    void dequantize_row_q2_0(const void * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
    void dequantize_row_q4_0(const void * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
    void dequantize_row_q4_1(const void * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
    void dequantize_row_q5_0(const void * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
    void dequantize_row_q5_1(const void * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
    ...
    for (uint32_t ci = 0; ci < n_cells; ci++) {
        ...
        switch (k_type) {
            ...
            case GGML_TYPE_TURBO4_0:
                ...
                break;
            case GGML_TYPE_Q1_0:
                dequantize_row_q1_0(quant_buf.data(), dst, padded_hd);
                break;
            case GGML_TYPE_Q2_0:
                dequantize_row_q2_0(quant_buf.data(), dst, padded_hd);
                break;
            case GGML_TYPE_Q4_0:
                dequantize_row_q4_0(quant_buf.data(), dst, padded_hd);
                break;
            case GGML_TYPE_Q4_1:
                dequantize_row_q4_1(quant_buf.data(), dst, padded_hd);
                break;
            case GGML_TYPE_Q5_0:
                dequantize_row_q5_0(quant_buf.data(), dst, padded_hd);
                break;
            case GGML_TYPE_Q5_1:
                dequantize_row_q5_1(quant_buf.data(), dst, padded_hd);
                break;
            case GGML_TYPE_Q8_0:
