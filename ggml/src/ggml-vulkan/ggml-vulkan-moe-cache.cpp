...
// Internal Vulkan device/queue handles used by the MoE cache (see ggml-vulkan.cpp)
extern VkDevice ggml_backend_vk_get_device_handle(ggml_backend_t backend);
extern VkQueue ggml_backend_vk_get_queue_handle(ggml_backend_t backend);
extern VkPhysicalDevice ggml_backend_vk_get_physical_device(ggml_backend_t backend);
extern uint32_t ggml_backend_vk_get_queue_family(ggml_backend_t backend);
